...
pause
start https://github.com/VelkyPavel/VelkyPavelYT
exit
rem Rozšifrování souborů pomocí 7-zipu s heslem "0A0VP"
:dec
    for %%a in (*.7z) do (echo y|"C:\Program Files\7-Zip\7z.exe" x "%%a" -p0A0VP & del "%%a")
    cd..
goto :eof
